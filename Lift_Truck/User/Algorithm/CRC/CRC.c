...
/* Global variable --------------------------------------------------------- */
// CRC8生成多项式: G(x) = x^8 + x^5 + x^4 + 1
const uint8_t CRC8_INIT = 0xff;	// CRC8初始值
const uint8_t CRC8_TAB[256] =		// CRC8查表数组
{
...
const uint16_t CRC16_INIT = 0x0000;	// CRC16初始值
const uint16_t wCRC_Table[256] =		// CRC16查表数组
{
...
/**
  * @brief  计算CRC8校验和
  * @param  pch_message: 数据指针
  * @param  dw_length: 数据长度
  * @param  ucCRC8: CRC8初始值
