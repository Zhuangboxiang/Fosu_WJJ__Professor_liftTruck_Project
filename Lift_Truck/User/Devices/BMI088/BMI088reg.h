...
/* Defines ------------------------------------------------------------------ */
/* 加速度计寄存器 */
#define BMI088_ACC_CHIP_ID				0x00		// "Who am I" 寄存器
#define BMI088_ACC_CHIP_ID_VALUE		0x1E		// "Who am I" 寄存器值
...
#define BMI088_ACCEL_XOUT_M				0x13		// X轴加速度高字节
#define BMI088_ACCEL_YOUT_L				0x14		// Y轴加速度低字节
#define BMI088_ACCEL_YOUT_M				0x15		// Y轴加速度高字节
#define BMI088_ACCEL_ZOUT_L				0x16		// Z轴加速度低字节
#define BMI088_ACCEL_ZOUT_M				0x17		// Z轴加速度高字节

#define BMI088_SENSORTIME_DATA_L		0x18		// 传感器时间低字节
#define BMI088_SENSORTIME_DATA_M		0x19		// 传感器时间中字节
#define BMI088_SENSORTIME_DATA_H		0x1A		// 传感器时间高字节

#define BMI088_ACC_INT_STAT_1			    0x1D		// 中断状态寄存器1
#define BMI088_ACCEL_DRDY_INTERRUPT_SHFITS	0x7
#define BMI088_ACCEL_DRDY_INTERRUPT		    (1 << BMI088_ACCEL_DRDY_INTERRUPT_SHFITS)

#define BMI088_TEMP_M					0x22		// 温度高字节
#define BMI088_TEMP_L					0x23		// 温度低字节
...
#define BMI088_INT2_IO_CTRL				    0x54		// 中断2 IO控制寄存器
...
/* 陀螺仪寄存器 */
#define BMI088_GYRO_CHIP_ID				0x00		// "Who am I" 寄存器
#define BMI088_GYRO_CHIP_ID_VALUE		0x0F		// "Who am I" 寄存器值
...
#define BMI088_GYRO_INT_STAT_1			0x0A		// 中断状态寄存器1
...
#define BMI088_GYRO_INT3_INT4_IO_CONF	0x16		// 中断3/4 IO配置寄存器
...
#define BMI088_GYRO_INT3_INT4_IO_MAP	0x18		// 中断3/4 IO映射寄存器
...
#define BMI088_GYRO_SELF_TEST			0x3C		// 陀螺仪自检寄存器
